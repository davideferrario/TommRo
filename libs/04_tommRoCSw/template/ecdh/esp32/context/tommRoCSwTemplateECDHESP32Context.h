...
#ifndef TOMMROC_SW_TEMPLATE_ECDH_ESP32_CONTEXT_H_
#define TOMMROC_SW_TEMPLATE_ECDH_ESP32_CONTEXT_H_
...
typedef struct {
    ...
    mbedtls_ecp_point   Qp;     // Public key of the peer.
    mbedtls_mpi         z;      // Shared secret.

} tommRoC_sw_template_ecdh_esp32_context_t;
