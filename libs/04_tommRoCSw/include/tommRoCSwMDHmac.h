...
#ifndef TOMMROC_SW_MD_HMAC_H_
#define TOMMROC_SW_MD_HMAC_H_
...
/**
 * Start MD HMAC software framework.
 * NOTE: tommRoC library MD HMAC environment will be init to use tommRoCSw software MD HMAC functions.
 *
