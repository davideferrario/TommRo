...
#ifndef TOMMROC_SW_AES_H_
#define TOMMROC_SW_AES_H_
...
/**
 * Start AES software encryption/decryption framework.
 * NOTE: tommRoC library AES crypto environment will be init to use tommRoCSw software AES functions.
 *
...
/**
 * Stop AES software encryption/decryption framework.
 *
 * return tommRoC_sw_err_enum_t
 */
