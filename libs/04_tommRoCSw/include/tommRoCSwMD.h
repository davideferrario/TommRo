...
#ifndef TOMMROC_SW_MD_H_
#define TOMMROC_SW_MD_H_
...
/**
 * Start MD software framework.
 * NOTE: tommRoC library MD environment will be init to use tommRoCSw software MD functions.
 *
