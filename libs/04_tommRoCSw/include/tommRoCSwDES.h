...
#ifndef TOMMROC_SW_DES_H_
#define TOMMROC_SW_DES_H_
...
/**
 * Start DES software encryption/decryption framework.
 * NOTE: tommRoC library DES crypto environment will be init to use tommRoCSw software DES functions.
 *
...
/**
 * Stop DES software encryption/decryption framework.
 *
 * return tommRoC_sw_err_enum_t
 */
