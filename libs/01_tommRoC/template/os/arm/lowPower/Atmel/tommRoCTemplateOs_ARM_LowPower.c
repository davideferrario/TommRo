...
#include "os/arm/lowPower/Atmel/waitMode/tommRoCTemplateOs_ARM_LowPowerWaitMode.h"
#include "os/arm/lowPower/Atmel/stopMode/tommRoCTemplateOs_ARM_LowPowerStopMode.h"
