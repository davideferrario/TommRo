...
#include "os/arm/lowPower/Nordic/waitMode/tommRoCTemplateOs_ARM_LowPowerWaitMode.h"
#include "os/arm/lowPower/Nordic/stopMode/tommRoCTemplateOs_ARM_LowPowerStopMode.h"
...
static tommRoC_err_enum_t _prepare_for_stop(const uint32_t msec) {
    ...
    // Set SEVONPEND in System Control Block (SCB).
...
static tommRoC_err_enum_t _restore_from_stop(const uint32_t msec) {
    ...
    // Clear SEVONPEND in System Control Block (SCB).
    SCB->SCR &= (uint32_t) ~SCB_SCR_SEVONPEND_Msk;
