...
static tommRoC_err_enum_t _sha(
    ...
    res = LTC_HASH(
            ...
            0,
            outputBufferPtr,
            TOMMROC_CRYPTO_SHA512_RESULT_SIZE_BYTE);
...
tommRoC_err_enum_t tommRoCTemplateCryptoSHA512Start(void) {
    ...
    TOMMROC_ERR_IF_TOMMROC_LIB_FUNCT_NOT_SUCCESS_RETURN_RESULT(tommRoCCryptoSHA512InitEnv(_sha));
...
tommRoC_err_enum_t tommRoCTemplateCryptoSHA512Stop(void) {

#if defined (__TOMMROC_USE_CRYPTO_SHA512_TEMPLATE__)                    &&  \
    defined (FSL_FEATURE_SOC_LTC_COUNT) && FSL_FEATURE_SOC_LTC_COUNT    &&  \
    defined (FSL_FEATURE_LTC_HAS_SHA) && FSL_FEATURE_LTC_HAS_SHA

    TOMMROC_ERR_IF_TOMMROC_LIB_FUNCT_NOT_SUCCESS_RETURN_RESULT(tommRoCCryptoSHA512CloseEnv());
