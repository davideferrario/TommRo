...
#ifndef TOMMROC_HW_DEVICES_SENSOR_HTS221_H_
#define TOMMROC_HW_DEVICES_SENSOR_HTS221_H_
...
#define TOMMROC_HW_DEVICES_SENSOR_HTS221_I2C_7_BIT_ADDRESS  (0b1011111)


// Device data.
#define TOMMROC_HW_DEVICES_SENSOR_HTS221_DEVICE_DATA_SIZE   (   TOMMROC_UTIL_FLOAT_SIZE +   \
...
typedef struct {
    ...
    // Operating mode.
    tommRoC_hw_devices_def_operating_mode_enum_t    operatingMode;

    // Conversion mode.
    tommRoC_hw_mems_def_conversion_mode_enum_t      conversionMode;

} tommRoC_hw_devices_sensor_hts221_config_t;

#define __EMPTY_tommRoC_hw_devices_sensor_hts221_config_t__                     \
{                                                                               \
...
typedef struct {
    uint8_t data[TOMMROC_HW_DEVICES_SENSOR_HTS221_DEVICE_DATA_SIZE];
} tommRoC_hw_devices_sensor_hts221_device_data_t;
 ...
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesSensorHTS221InitI2C(
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesSensorHTS221InitSPI(
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesSensorHTS221AttachDeviceData(
        const   tommRoC_hw_devices_sensor_hts221_device_data_t* const   deviceDataPtr,
                tommRoC_hw_bus_device_t*                        const   busDevicePtr);
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesSensorHTS221Start(
        const   tommRoC_hw_devices_sensor_hts221_config_t*  const   configPtr,
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesSensorHTS221Get(
        const   tommRoC_hw_bus_device_t*                        const   busDevicePtr,
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesSensorHTS221Sleep(
        const   tommRoC_hw_bus_device_t*                        const   busDevicePtr);

tommRoC_hw_err_enum_t tommRoCHwDevicesSensorHTS221Wake(
        const   tommRoC_hw_bus_device_t*                        const   busDevicePtr);
