...
#ifndef TOMMROC_HW_DEVICES_RTC_DS134x_H_
#define TOMMROC_HW_DEVICES_RTC_DS134x_H_
...
#define TOMMROC_HW_DEVICES_RTC_DS134x_I2C_7_BIT_ADDRESS     (0b1101000)
 ...
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesRTCDS134xInitI2C(
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesRTCDS134xStart(
        const   tommRoC_hw_bus_device_t*    const   busDevicePtr);

/**
 * Get a date time from DS134x RTC.
 *
 * param[in]        busDevicePtr            bus device pointer.
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesRTCDS134xGetDateTime(
        const   tommRoC_hw_bus_device_t*    const   busDevicePtr,
                tommRoC_date_time_t*        const   dateTimePtr);

/**
 * Set a date time for DS134x RTC.
 *
 * param[in]        busDevicePtr            bus device pointer.
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesRTCDS134xSetDateTime(
        const   tommRoC_hw_bus_device_t*    const   busDevicePtr,
