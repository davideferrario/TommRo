...
#ifndef TOMMROC_HW_DEVICES_RTC_PCF85063A_H_
#define TOMMROC_HW_DEVICES_RTC_PCF85063A_H_
...
#define TOMMROC_HW_DEVICES_RTC_PCF85063A_I2C_7_BIT_ADDRESS  (0b1010001)
 ...
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesRTCPCF85063AInitI2C(
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesRTCPCF85063AStart(
        const   tommRoC_hw_bus_device_t*    const   busDevicePtr);

/**
 * Get a date time from PCF85063A RTC.
 *
 * param[in]        busDevicePtr            bus device pointer.
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesRTCPCF85063AGetDateTime(
        const   tommRoC_hw_bus_device_t*    const   busDevicePtr,
                tommRoC_date_time_t*        const   dateTimePtr);

/**
 * Set a date time for PCF85063A RTC.
 *
 * param[in]        busDevicePtr            bus device pointer.
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesRTCPCF85063ASetDateTime(
        const   tommRoC_hw_bus_device_t*    const   busDevicePtr,
