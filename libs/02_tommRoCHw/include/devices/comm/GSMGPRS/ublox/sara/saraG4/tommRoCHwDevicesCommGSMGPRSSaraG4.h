...
#ifndef TOMMROC_HW_DEVICES_COMM_GSM_GPRS_SARA_G4_H_
#define TOMMROC_HW_DEVICES_COMM_GSM_GPRS_SARA_G4_H_
...
/**
 * NOTE:
 * from AT commands manual - 26.3.1 section: Up to 7 sockets can be created.
 */
#define TOMMROC_HW_DEVICES_COMM_GSM_GPRS_SARA_G4_ACTIVE_SOCKET_AMOUNT       (7)


// Device data.
#define TOMMROC_HW_DEVICES_COMM_GSM_GPRS_SARA_G4_DEVICE_DATA_SIZE   (   TOMMROC_UTIL_FUNCT_PTR_SIZE                         +   \
...
typedef enum {
    ...
    TOMMROC_HW_DEVICES_COMM_GSM_GPRS_SARA_G4_SMS_STAT_REC_UNREAD = 0,
    TOMMROC_HW_DEVICES_COMM_GSM_GPRS_SARA_G4_SMS_STAT_REC_READ,
    TOMMROC_HW_DEVICES_COMM_GSM_GPRS_SARA_G4_SMS_STAT_STO_UNSENT,
    TOMMROC_HW_DEVICES_COMM_GSM_GPRS_SARA_G4_SMS_STAT_STO_SENT,

} tommRoC_hw_devices_comm_gsm_gprs_sara_g4_sms_stat_enum_t;

// Device data.
// NOTE: HAVE to be a static variable.
typedef struct {
    uint8_t data[TOMMROC_HW_DEVICES_COMM_GSM_GPRS_SARA_G4_DEVICE_DATA_SIZE];
} tommRoC_hw_devices_comm_gsm_gprs_sara_g4_device_data_t;
 ...
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommGSMGPRSSaraG4InitUART(
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommGSMGPRSSaraG4AttachDeviceData(
        const   tommRoC_hw_devices_comm_gsm_gprs_sara_g4_device_data_t*         const   deviceDataPtr,
                tommRoC_hw_bus_device_t*                                        const   busDevicePtr);
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommGSMGPRSSaraG4Start(
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommGSMGPRSSaraG4IMEIRead(
        const   tommRoC_hw_bus_device_t*                                        const   busDevicePtr,
...
tommRoC_hw_err_enum_t tommRoCHwDevicesCommGSMGPRSSaraG4SMSReadMessage(
        const   tommRoC_hw_bus_device_t*                                        const   busDevicePtr,
        const   uint32_t                                                                index,
                tommRoC_hw_devices_comm_gsm_gprs_sara_g4_sms_stat_enum_t*       const   statPtr,
...
tommRoC_hw_err_enum_t tommRoCHwDevicesCommGSMGPRSSaraG4SMSSendMessage(
        const   tommRoC_hw_bus_device_t*                                        const   busDevicePtr,
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommGSMGPRSSaraG4PDPContextActive(
        const   tommRoC_hw_bus_device_t*                                        const   busDevicePtr);
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommGSMGPRSSaraG4PDPContextDeactive(
        const   tommRoC_hw_bus_device_t*                                        const   busDevicePtr);
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommGSMGPRSSaraG4GetNetworkStatus(
        const   tommRoC_hw_bus_device_t*                                        const   busDevicePtr,
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommGSMGPRSSaraG4PDPGetIPAddress(
        const   tommRoC_hw_bus_device_t*                                        const   busDevicePtr,
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommGSMGPRSSaraG4SocketTCPClientStart(
        const   tommRoC_hw_bus_device_t*                                        const   busDevicePtr,
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommGSMGPRSSaraG4SocketTCPClientStartHost(
        const   tommRoC_hw_bus_device_t*                                        const   busDevicePtr,
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommGSMGPRSSaraG4SocketTCPClientStop(
        const   tommRoC_hw_bus_device_t*                                        const   busDevicePtr,
                tommRoC_hw_net_socket_def_t*                                    const   socketPtr);
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommGSMGPRSSaraG4SocketTCPClientSendBuffer(
        const   tommRoC_hw_bus_device_t*                                        const   busDevicePtr,
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommGSMGPRSSaraG4SocketTCPClientDataReady(
        const   tommRoC_hw_bus_device_t*                                        const   busDevicePtr,
        const   tommRoC_hw_net_socket_def_t*                                    const   socketPtr,
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommGSMGPRSSaraG4SocketTCPClientReadBuffer(
        const   tommRoC_hw_bus_device_t*                                        const   busDevicePtr,
        const   tommRoC_hw_net_socket_def_t*                                    const   socketPtr,
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommGSMGPRSSaraG4NetSocketOnlyClient(
        const   tommRoC_hw_bus_device_t*                                        const   busDevicePtr,
        const   tommRoC_guard_t*                                                const   guardPtr);
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommGSMGPRSSaraG4NetSocketClose(
        const   tommRoC_hw_bus_device_t*                                        const   busDevicePtr);
