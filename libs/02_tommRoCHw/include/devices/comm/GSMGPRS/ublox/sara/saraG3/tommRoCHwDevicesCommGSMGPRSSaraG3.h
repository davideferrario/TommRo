...
#ifndef TOMMROC_HW_DEVICES_COMM_GSM_GPRS_SARA_G3_H_
#define TOMMROC_HW_DEVICES_COMM_GSM_GPRS_SARA_G3_H_
 ...
 */
#define TOMMROC_HW_DEVICES_COMM_GSM_GPRS_SARA_G3_ACTIVE_SOCKET_AMOUNT       (7)


// Device data.
#define TOMMROC_HW_DEVICES_COMM_GSM_GPRS_SARA_G3_DEVICE_DATA_SIZE   (   TOMMROC_UTIL_FUNCT_PTR_SIZE                         +   \
...
typedef enum {
    ...
    TOMMROC_HW_DEVICES_COMM_GSM_GPRS_SARA_G3_SMS_STAT_REC_UNREAD = 0,
    TOMMROC_HW_DEVICES_COMM_GSM_GPRS_SARA_G3_SMS_STAT_REC_READ,
    TOMMROC_HW_DEVICES_COMM_GSM_GPRS_SARA_G3_SMS_STAT_STO_UNSENT,
    TOMMROC_HW_DEVICES_COMM_GSM_GPRS_SARA_G3_SMS_STAT_STO_SENT,

} tommRoC_hw_devices_comm_gsm_gprs_sara_g3_sms_stat_enum_t;

// Device data.
// NOTE: HAVE to be a static variable.
typedef struct {
    uint8_t data[TOMMROC_HW_DEVICES_COMM_GSM_GPRS_SARA_G3_DEVICE_DATA_SIZE];
} tommRoC_hw_devices_comm_gsm_gprs_sara_g3_device_data_t;
 ...
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommGSMGPRSSaraG3InitUART(
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommGSMGPRSSaraG3AttachDeviceData(
        const   tommRoC_hw_devices_comm_gsm_gprs_sara_g3_device_data_t*         const   deviceDataPtr,
                tommRoC_hw_bus_device_t*                                        const   busDevicePtr);
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommGSMGPRSSaraG3Start(
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommGSMGPRSSaraG3IMEIRead(
        const   tommRoC_hw_bus_device_t*                                        const   busDevicePtr,
...
tommRoC_hw_err_enum_t tommRoCHwDevicesCommGSMGPRSSaraG3SMSReadMessage(
        const   tommRoC_hw_bus_device_t*                                        const   busDevicePtr,
        const   uint32_t                                                                index,
                tommRoC_hw_devices_comm_gsm_gprs_sara_g3_sms_stat_enum_t*       const   statPtr,
...
tommRoC_hw_err_enum_t tommRoCHwDevicesCommGSMGPRSSaraG3SMSSendMessage(
        const   tommRoC_hw_bus_device_t*                                        const   busDevicePtr,
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommGSMGPRSSaraG3PDPContextActive(
        const   tommRoC_hw_bus_device_t*                                        const   busDevicePtr);
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommGSMGPRSSaraG3PDPContextDeactive(
        const   tommRoC_hw_bus_device_t*                                        const   busDevicePtr);
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommGSMGPRSSaraG3GetNetworkStatus(
        const   tommRoC_hw_bus_device_t*                                        const   busDevicePtr,
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommGSMGPRSSaraG3PDPGetIPAddress(
        const   tommRoC_hw_bus_device_t*                                        const   busDevicePtr,
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommGSMGPRSSaraG3SocketTCPClientStart(
        const   tommRoC_hw_bus_device_t*                                        const   busDevicePtr,
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommGSMGPRSSaraG3SocketTCPClientStartHost(
        const   tommRoC_hw_bus_device_t*                                        const   busDevicePtr,
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommGSMGPRSSaraG3SocketTCPClientStop(
        const   tommRoC_hw_bus_device_t*                                        const   busDevicePtr,
                tommRoC_hw_net_socket_def_t*                                    const   socketPtr);
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommGSMGPRSSaraG3SocketTCPClientSendBuffer(
        const   tommRoC_hw_bus_device_t*                                        const   busDevicePtr,
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommGSMGPRSSaraG3SocketTCPClientDataReady(
        const   tommRoC_hw_bus_device_t*                                        const   busDevicePtr,
        const   tommRoC_hw_net_socket_def_t*                                    const   socketPtr,
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommGSMGPRSSaraG3SocketTCPClientReadBuffer(
        const   tommRoC_hw_bus_device_t*                                        const   busDevicePtr,
        const   tommRoC_hw_net_socket_def_t*                                    const   socketPtr,
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommGSMGPRSSaraG3NetSocketOnlyClient(
        const   tommRoC_hw_bus_device_t*                                        const   busDevicePtr,
        const   tommRoC_guard_t*                                                const   guardPtr);
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommGSMGPRSSaraG3NetSocketClose(
        const   tommRoC_hw_bus_device_t*                                        const   busDevicePtr);
