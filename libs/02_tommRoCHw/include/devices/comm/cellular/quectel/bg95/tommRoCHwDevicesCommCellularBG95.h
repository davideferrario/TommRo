...
#ifndef TOMMROC_HW_DEVICES_COMM_CELLULAR_BG95_H_
#define TOMMROC_HW_DEVICES_COMM_CELLULAR_BG95_H_
...
#define TOMMROC_HW_DEVICES_COMM_CELLULAR_BG95_WAIT_FOR_NETWORK_DEFAULT_TIMEOUT_mSEC (TOMMROC_UNIT_MEASURE_TIME_MIN_TO_mSEC(2))

/**
 * NOTE:
 * limited to 7 sockets because of internal implementation.
 */
#define TOMMROC_HW_DEVICES_COMM_CELLULAR_BG95_ACTIVE_SOCKET_AMOUNT  (7)

// Default LwIP PPP AUTH parameters.
#define TOMMROC_HW_DEVICES_COMM_CELLULAR_BG95_LWIP_PPP_AUTH_TYPE_DEFAULT        (TOMMROC_HW_NET_LWIP_PPP_DEF_AUTH_TYPE_NONE)
#define TOMMROC_HW_DEVICES_COMM_CELLULAR_BG95_LWIP_PPP_AUTH_USER_STR_DEFAULT    (NULL)
#define TOMMROC_HW_DEVICES_COMM_CELLULAR_BG95_LWIP_PPP_AUTH_PASSWD_STR_DEFAULT  (NULL)

// Device data.
#define TOMMROC_HW_DEVICES_COMM_CELLULAR_BG95_DEVICE_DATA_SIZE  (   TOMMROC_UTIL_FUNCT_PTR_SIZE +   \
...
typedef struct {
    uint8_t data[TOMMROC_HW_DEVICES_COMM_CELLULAR_BG95_DEVICE_DATA_SIZE];
} tommRoC_hw_devices_comm_cellular_bg95_device_data_t;
 ...
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommCellularBG95InitUART(
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommCellularBG95AttachDeviceData(
        const   tommRoC_hw_devices_comm_cellular_bg95_device_data_t*            const   deviceDataPtr,
                tommRoC_hw_bus_device_t*                                        const   busDevicePtr);

/**
 * Start chip.
 *
 * param[in]        pwrkeyLow               set PWRKEY pin low function pointer (NULL if none).
 * param[in]        pwrkeyHigh              set PWRKEY pin high function pointer (NULL if none).
 ...
 * param[in]        status                  get status pin status function pointer (NULL if none).
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommCellularBG95Start(
        const   tommRoC_hw_gpio_set_cb_t                                                pwrkeyLow,
        const   tommRoC_hw_gpio_set_cb_t                                                pwrkeyHigh,
        const   tommRoC_hw_gpio_set_cb_t                                                resetNLow,
        const   tommRoC_hw_gpio_set_cb_t                                                resetNHigh,
        const   tommRoC_hw_gpio_get_cb_t                                                status,
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommCellularBG95StartForLwIP(
        const   tommRoC_hw_gpio_set_cb_t                                                pwrkeyLow,
        const   tommRoC_hw_gpio_set_cb_t                                                pwrkeyHigh,
        const   tommRoC_hw_gpio_set_cb_t                                                resetNLow,
        const   tommRoC_hw_gpio_set_cb_t                                                resetNHigh,
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommCellularBG95IMEIRead(
        const   tommRoC_hw_bus_device_t*                                        const   busDevicePtr,
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommCellularBG95IMSIRead(
        const   tommRoC_hw_bus_device_t*                                        const   busDevicePtr,
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommCellularBG95GetNetworkStatus(
        const   tommRoC_hw_bus_device_t*                                        const   busDevicePtr,
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommCellularBG95GetIPAddress(
        const   tommRoC_hw_bus_device_t*                                        const   busDevicePtr,
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommCellularBG95GetSignalInfo(
        const   tommRoC_hw_bus_device_t*                                        const   busDevicePtr,
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommCellularBG95SocketTCPClientConnect(
        const   tommRoC_hw_bus_device_t*                                        const   busDevicePtr,
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommCellularBG95SocketTCPClientConnectHost(
        const   tommRoC_hw_bus_device_t*                                        const   busDevicePtr,
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommCellularBG95SocketTCPClientClose(
        const   tommRoC_hw_bus_device_t*                                        const   busDevicePtr,
                tommRoC_hw_net_socket_def_t*                                    const   socketPtr);
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommCellularBG95SocketTCPClientSendBuffer(
        const   tommRoC_hw_bus_device_t*                                        const   busDevicePtr,
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommCellularBG95SocketTCPClientDataReady(
        const   tommRoC_hw_bus_device_t*                                        const   busDevicePtr,
        const   tommRoC_hw_net_socket_def_t*                                    const   socketPtr,
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommCellularBG95SocketTCPClientReadBuffer(
        const   tommRoC_hw_bus_device_t*                                        const   busDevicePtr,
        const   tommRoC_hw_net_socket_def_t*                                    const   socketPtr,
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommCellularBG95NetSocketOnlyClient(
        const   tommRoC_hw_bus_device_t*                                        const   busDevicePtr,
        const   tommRoC_guard_t*                                                const   guardPtr);
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommCellularBG95NetSocketClose(
        const   tommRoC_hw_bus_device_t*                                        const   busDevicePtr);
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommCellularBG95LwIPOnlyClient(
        const   tommRoC_hw_bus_device_t*                                        const   busDevicePtr,
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommCellularBG95LwIPClose(
        const   tommRoC_hw_bus_device_t*                                        const   busDevicePtr);
