...
#ifndef TOMMROC_HW_DEVICES_COMM_CELLULAR_LARA_R6_H_
#define TOMMROC_HW_DEVICES_COMM_CELLULAR_LARA_R6_H_
...
#define TOMMROC_HW_DEVICES_COMM_CELLULAR_LARA_R6_WAIT_FOR_NETWORK_DEFAULT_TIMEOUT_mSEC  (TOMMROC_UNIT_MEASURE_TIME_MIN_TO_mSEC(2))

/**
 * NOTE:
 * from AT commands manual - 26.1.1 section: Up to 7 sockets can be created.
 */
#define TOMMROC_HW_DEVICES_COMM_CELLULAR_LARA_R6_ACTIVE_SOCKET_AMOUNT   (7)

// Default LwIP PPP AUTH parameters.
#define TOMMROC_HW_DEVICES_COMM_CELLULAR_LARA_R6_LWIP_PPP_AUTH_TYPE_DEFAULT         (TOMMROC_HW_NET_LWIP_PPP_DEF_AUTH_TYPE_NONE)
#define TOMMROC_HW_DEVICES_COMM_CELLULAR_LARA_R6_LWIP_PPP_AUTH_USER_STR_DEFAULT     (NULL)
#define TOMMROC_HW_DEVICES_COMM_CELLULAR_LARA_R6_LWIP_PPP_AUTH_PASSWD_STR_DEFAULT   (NULL)


// Device data.
#define TOMMROC_HW_DEVICES_COMM_CELLULAR_LARA_R6_DEVICE_DATA_SIZE   (   TOMMROC_UTIL_FUNCT_PTR_SIZE +   \
...
typedef struct {
    uint8_t data[TOMMROC_HW_DEVICES_COMM_CELLULAR_LARA_R6_DEVICE_DATA_SIZE];
} tommRoC_hw_devices_comm_cellular_lara_r6_device_data_t;
 ...
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommCellularLaraR6InitUART(
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommCellularLaraR6AttachDeviceData(
        const   tommRoC_hw_devices_comm_cellular_lara_r6_device_data_t*         const   deviceDataPtr,
                tommRoC_hw_bus_device_t*                                        const   busDevicePtr);
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommCellularLaraR6Start(
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommCellularLaraR6StartForLwIP(
        const   tommRoC_hw_gpio_set_cb_t                                                pwrOnLow,
        const   tommRoC_hw_gpio_set_cb_t                                                pwrOnHigh,
        const   tommRoC_hw_gpio_set_cb_t                                                resetNLow,
        const   tommRoC_hw_gpio_set_cb_t                                                resetNHigh,
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommCellularLaraR6IMEIRead(
        const   tommRoC_hw_bus_device_t*                                        const   busDevicePtr,
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommCellularLaraR6IMSIRead(
        const   tommRoC_hw_bus_device_t*                                        const   busDevicePtr,
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommCellularLaraR6GetNetworkStatus(
        const   tommRoC_hw_bus_device_t*                                        const   busDevicePtr,
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommCellularLaraR6GetIPAddress(
        const   tommRoC_hw_bus_device_t*                                        const   busDevicePtr,
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommCellularLaraR6GetSignalInfo(
        const   tommRoC_hw_bus_device_t*                                        const   busDevicePtr,
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommCellularLaraR6SocketTCPClientConnect(
        const   tommRoC_hw_bus_device_t*                                        const   busDevicePtr,
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommCellularLaraR6SocketTCPClientConnectHost(
        const   tommRoC_hw_bus_device_t*                                        const   busDevicePtr,
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommCellularLaraR6SocketTCPClientClose(
        const   tommRoC_hw_bus_device_t*                                        const   busDevicePtr,
                tommRoC_hw_net_socket_def_t*                                    const   socketPtr);
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommCellularLaraR6SocketTCPClientSendBuffer(
        const   tommRoC_hw_bus_device_t*                                        const   busDevicePtr,
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommCellularLaraR6SocketTCPClientDataReady(
        const   tommRoC_hw_bus_device_t*                                        const   busDevicePtr,
        const   tommRoC_hw_net_socket_def_t*                                    const   socketPtr,
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommCellularLaraR6SocketTCPClientReadBuffer(
        const   tommRoC_hw_bus_device_t*                                        const   busDevicePtr,
        const   tommRoC_hw_net_socket_def_t*                                    const   socketPtr,
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommCellularLaraR6NetSocketOnlyClient(
        const   tommRoC_hw_bus_device_t*                                        const   busDevicePtr,
        const   tommRoC_guard_t*                                                const   guardPtr);
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommCellularLaraR6NetSocketClose(
        const   tommRoC_hw_bus_device_t*                                        const   busDevicePtr);
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommCellularLaraR6LwIPOnlyClient(
        const   tommRoC_hw_bus_device_t*                                        const   busDevicePtr,
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommCellularLaraR6LwIPClose(
        const   tommRoC_hw_bus_device_t*                                        const   busDevicePtr);
