...
#ifndef TOMMROC_HW_DEVICES_COMM_CELLULAR_ME310G1_H_
#define TOMMROC_HW_DEVICES_COMM_CELLULAR_ME310G1_H_
...
#define TOMMROC_HW_DEVICES_COMM_CELLULAR_ME310G1_WAIT_FOR_NETWORK_DEFAULT_TIMEOUT_mSEC  (TOMMROC_UNIT_MEASURE_TIME_MIN_TO_mSEC(2))

#define TOMMROC_HW_DEVICES_COMM_CELLULAR_ME310G1_ACTIVE_SOCKET_AMOUNT   (6)

// Default LwIP PPP AUTH parameters.
#define TOMMROC_HW_DEVICES_COMM_CELLULAR_ME310G1_LWIP_PPP_AUTH_TYPE_DEFAULT         (TOMMROC_HW_NET_LWIP_PPP_DEF_AUTH_TYPE_NONE)
#define TOMMROC_HW_DEVICES_COMM_CELLULAR_ME310G1_LWIP_PPP_AUTH_USER_STR_DEFAULT     (NULL)
#define TOMMROC_HW_DEVICES_COMM_CELLULAR_ME310G1_LWIP_PPP_AUTH_PASSWD_STR_DEFAULT   (NULL)


// Device data.
#define TOMMROC_HW_DEVICES_COMM_CELLULAR_ME310G1_DEVICE_DATA_SIZE   (   TOMMROC_UTIL_FUNCT_PTR_SIZE +   \
...
typedef struct {
    uint8_t data[TOMMROC_HW_DEVICES_COMM_CELLULAR_ME310G1_DEVICE_DATA_SIZE];
} tommRoC_hw_devices_comm_cellular_me310g1_device_data_t;
 ...
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommCellularME310G1InitUART(
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommCellularME310G1AttachDeviceData(
        const   tommRoC_hw_devices_comm_cellular_me310g1_device_data_t*         const   deviceDataPtr,
                tommRoC_hw_bus_device_t*                                        const   busDevicePtr);

/**
 * Start chip.
 *
 * param[in]        OnOffLow                set ON_OFF pin low function pointer (NULL if none).
 * param[in]        OnOffHigh               set ON_OFF pin high function pointer (NULL if none).
 * param[in]        PwrMonStatus            get PWRMON pin status function pointer (NULL if none).
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommCellularME310G1Start(
        const   tommRoC_hw_gpio_set_cb_t                                                OnOffLow,
        const   tommRoC_hw_gpio_set_cb_t                                                OnOffHigh,
        const   tommRoC_hw_gpio_get_cb_t                                                PwrMonStatus,
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommCellularME310G1StartForLwIP(
        const   tommRoC_hw_gpio_set_cb_t                                                OnOffLow,
        const   tommRoC_hw_gpio_set_cb_t                                                OnOffHigh,
        const   tommRoC_hw_gpio_get_cb_t                                                PwrMonStatus,
        const   uint32_t                                                                baudRate,
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommCellularME310G1IMEIRead(
        const   tommRoC_hw_bus_device_t*                                        const   busDevicePtr,
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommCellularME310G1IMSIRead(
        const   tommRoC_hw_bus_device_t*                                        const   busDevicePtr,
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommCellularME310G1GetNetworkStatus(
        const   tommRoC_hw_bus_device_t*                                        const   busDevicePtr,
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommCellularME310G1GetIPAddress(
        const   tommRoC_hw_bus_device_t*                                        const   busDevicePtr,
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommCellularME310G1GetSignalInfo(
        const   tommRoC_hw_bus_device_t*                                        const   busDevicePtr,
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommCellularME310G1SocketTCPClientConnect(
        const   tommRoC_hw_bus_device_t*                                        const   busDevicePtr,
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommCellularME310G1SocketTCPClientConnectHost(
        const   tommRoC_hw_bus_device_t*                                        const   busDevicePtr,
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommCellularME310G1SocketTCPClientClose(
        const   tommRoC_hw_bus_device_t*                                        const   busDevicePtr,
                tommRoC_hw_net_socket_def_t*                                    const   socketPtr);
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommCellularME310G1SocketTCPClientSendBuffer(
        const   tommRoC_hw_bus_device_t*                                        const   busDevicePtr,
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommCellularME310G1SocketTCPClientDataReady(
        const   tommRoC_hw_bus_device_t*                                        const   busDevicePtr,
        const   tommRoC_hw_net_socket_def_t*                                    const   socketPtr,
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommCellularME310G1SocketTCPClientReadBuffer(
        const   tommRoC_hw_bus_device_t*                                        const   busDevicePtr,
        const   tommRoC_hw_net_socket_def_t*                                    const   socketPtr,
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommCellularME310G1NetSocketOnlyClient(
        const   tommRoC_hw_bus_device_t*                                        const   busDevicePtr,
        const   tommRoC_guard_t*                                                const   guardPtr);
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommCellularME310G1NetSocketClose(
        const   tommRoC_hw_bus_device_t*                                        const   busDevicePtr);
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommCellularME310G1LwIPOnlyClient(
        const   tommRoC_hw_bus_device_t*                                        const   busDevicePtr,
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesCommCellularME310G1LwIPClose(
        const   tommRoC_hw_bus_device_t*                                        const   busDevicePtr);
