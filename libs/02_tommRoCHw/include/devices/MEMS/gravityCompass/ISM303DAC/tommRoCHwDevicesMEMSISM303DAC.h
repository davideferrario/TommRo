...
#ifndef TOMMROC_HW_DEVICES_MEMS_ISM303DAC_H_
#define TOMMROC_HW_DEVICES_MEMS_ISM303DAC_H_
...
#define TOMMROC_HW_DEVICES_MEMS_ISM303DAC_GRAVITY_I2C_7_BIT_ADDRESS (0b0011101)
#define TOMMROC_HW_DEVICES_MEMS_ISM303DAC_COMPASS_I2C_7_BIT_ADDRESS (0b0011110)


// Device data.
#define TOMMROC_HW_DEVICES_MEMS_ISM303DAC_DEVICE_DATA_SIZE  (   TOMMROC_UTIL_U8_SIZE    +   \
...
typedef struct {
     ...
     * From datasheet:
     *
     * When the activity/inactivity recognition function is activated, the ISM303DAC device is able
...
} tommRoC_hw_devices_mems_ism303dac_gravity_config_t;

#define __EMPTY_tommRoC_hw_devices_mems_ism303dac_gravity_config_t__                \
{                                                                                   \
...
} tommRoC_hw_devices_mems_ism303dac_compass_config_t;

#define __EMPTY_tommRoC_hw_devices_mems_ism303dac_compass_config_t__                \
{                                                                                   \
    /* .operatingMode */        TOMMRO_C_HW_DEVICES_DEF_OPERATING_MODE_LOW_POWER,   \
...
typedef struct {
    ...
    tommRoC_hw_devices_mems_ism303dac_gravity_config_t  gravityConfig;
    tommRoC_hw_devices_mems_ism303dac_compass_config_t  compassConfig;

} tommRoC_hw_devices_mems_ism303dac_config_t;

#define __EMPTY_tommRoC_hw_devices_mems_ism303dac_config_t__                                \
{                                                                                           \
    /* .gravityConfig */    __EMPTY_tommRoC_hw_devices_mems_ism303dac_gravity_config_t__,   \
    /* .compassConfig */    __EMPTY_tommRoC_hw_devices_mems_ism303dac_compass_config_t__,   \
}
...
typedef struct {
    uint8_t data[TOMMROC_HW_DEVICES_MEMS_ISM303DAC_DEVICE_DATA_SIZE];
} tommRoC_hw_devices_mems_ism303dac_device_data_t;
 ...
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesMEMSISM303DACInitI2C(
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesMEMSISM303DACInitSPI(
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesMEMSISM303DACAttachDeviceData(
        const   tommRoC_hw_devices_mems_ism303dac_device_data_t*    const   deviceDataPtr,
                tommRoC_hw_bus_device_t*                            const   busDevicePtr);
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesMEMSISM303DACStart(
        const   tommRoC_hw_devices_mems_ism303dac_config_t*         const   configPtr,
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesMEMSISM303DACGet(
        const   tommRoC_hw_bus_device_t*                            const   busDevicePtr,
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesMEMSISM303DACGravityGet(
        const   tommRoC_hw_bus_device_t*                            const   busDevicePtr,
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesMEMSISM303DACGravityGet16Bit(
        const   tommRoC_hw_bus_device_t*                            const   busDevicePtr,
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesMEMSISM303DACCompassGet(
        const   tommRoC_hw_bus_device_t*                            const   busDevicePtr,
                tommRoC_hw_mems_def_result_t*                       const   resultPtr);
