...
#ifndef TOMMROC_HW_DEVICES_MEMS_LIS2DTW12_H_
#define TOMMROC_HW_DEVICES_MEMS_LIS2DTW12_H_
...
#define TOMMROC_HW_DEVICES_MEMS_LIS2DTW12_I2C_7_BIT_ADDRESS_SA0_PIN_GND  (0b0011000)
#define TOMMROC_HW_DEVICES_MEMS_LIS2DTW12_I2C_7_BIT_ADDRESS_SA0_PIN_VDD  (0b0011001)


// Device data.
#define TOMMROC_HW_DEVICES_MEMS_LIS2DTW12_DEVICE_DATA_SIZE  (   TOMMROC_UTIL_BOOL_SIZE  +   \
...
} tommRoC_hw_devices_mems_lis2dtw12_config_t;

#define __EMPTY_tommRoC_hw_devices_mems_lis2dtw12_config_t__                         \
{                                                                                   \
...
typedef struct {
    uint8_t data[TOMMROC_HW_DEVICES_MEMS_LIS2DTW12_DEVICE_DATA_SIZE];
} tommRoC_hw_devices_mems_lis2dtw12_device_data_t;
 ...
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesMEMSLIS2DTW12InitI2C(
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesMEMSLIS2DTW12InitSPI(
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesMEMSLIS2DTW12AttachDeviceData(
        const   tommRoC_hw_devices_mems_lis2dtw12_device_data_t*    const   deviceDataPtr,
                tommRoC_hw_bus_device_t*                            const   busDevicePtr);
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesMEMSLIS2DTW12Start(
        const   tommRoC_hw_devices_mems_lis2dtw12_config_t*         const   configPtr,
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesMEMSLIS2DTW12Get(
        const   tommRoC_hw_bus_device_t*                            const   busDevicePtr,
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesMEMSLIS2DTW12Get16Bit(
        const   tommRoC_hw_bus_device_t*                            const   busDevicePtr,
                tommRoC_hw_mems_def_result_16bit_t*                 const   resultPtr);

/**
 * Get temperature as natural [float] format.
 *
 * param[in]        busDevicePtr            bus device pointer.
 * param[out]       resultPtr               result [°C] pointer.
 *
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesMEMSLIS2DTW12GetTemp(
        const   tommRoC_hw_bus_device_t*                            const   busDevicePtr,
                tommRoC_unit_measure_temperature_celsius_t*         const   resultPtr);

/**
 * Get temperature as signed 8-bit format.
 * NOTE: temperature output register in 8-bit resolution is used. Sensitivity = 1°C/LSB.
 *
 * param[in]        busDevicePtr            bus device pointer.
 * param[out]       resultPtr               result [°C] pointer.
 *
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesMEMSLIS2DTW12GetTemp8Bit(
        const   tommRoC_hw_bus_device_t*                            const   busDevicePtr,
