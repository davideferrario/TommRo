...
#ifndef TOMMROC_HW_DEVICES_MEMS_MC3479_H_
#define TOMMROC_HW_DEVICES_MEMS_MC3479_H_
...
#define TOMMROC_HW_DEVICES_MEMS_MC3479_I2C_7_BIT_ADDRESS_A6_PIN_GND (0b1001100)
#define TOMMROC_HW_DEVICES_MEMS_MC3479_I2C_7_BIT_ADDRESS_A6_PIN_VDD (0b1101100)


// Device data.
#define TOMMROC_HW_DEVICES_MEMS_MC3479_DEVICE_DATA_SIZE (TOMMROC_UTIL_U8_SIZE)
...
typedef struct {
    ...
    tommRoC_util_enabled_status_enum_t              lowPassFilterStatus;    // Status of low pass filter.

} tommRoC_hw_devices_mems_mc3479_config_t;

#define __EMPTY_tommRoC_hw_devices_mems_mc3479_config_t__                           \
{                                                                                   \
    ...
    /* .lowPassFilterStatus */  TOMMRO_C_UTIL_DISABLED,                             \
}
...
typedef struct {
    uint8_t data[TOMMROC_HW_DEVICES_MEMS_MC3479_DEVICE_DATA_SIZE];
} tommRoC_hw_devices_mems_mc3479_device_data_t;
 ...
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesMEMSMC3479InitI2C(
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesMEMSMC3479InitSPI(
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesMEMSMC3479AttachDeviceData(
        const   tommRoC_hw_devices_mems_mc3479_device_data_t*   const   deviceDataPtr,
                tommRoC_hw_bus_device_t*                        const   busDevicePtr);
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesMEMSMC3479Start(
        const   tommRoC_hw_devices_mems_mc3479_config_t*        const   configPtr,
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesMEMSMC3479Get(
        const   tommRoC_hw_bus_device_t*                        const   busDevicePtr,
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesMEMSMC3479Get16Bit(
        const   tommRoC_hw_bus_device_t*                        const   busDevicePtr,
