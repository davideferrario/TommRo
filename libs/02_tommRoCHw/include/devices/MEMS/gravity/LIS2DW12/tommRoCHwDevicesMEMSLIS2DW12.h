...
#ifndef TOMMROC_HW_DEVICES_MEMS_LIS2DW12_H_
#define TOMMROC_HW_DEVICES_MEMS_LIS2DW12_H_
...
#define TOMMROC_HW_DEVICES_MEMS_LIS2DW12_I2C_7_BIT_ADDRESS_SA0_PIN_GND  (0b0011000)
#define TOMMROC_HW_DEVICES_MEMS_LIS2DW12_I2C_7_BIT_ADDRESS_SA0_PIN_VDD  (0b0011001)


// Device data.
#define TOMMROC_HW_DEVICES_MEMS_LIS2DW12_DEVICE_DATA_SIZE   (   TOMMROC_UTIL_BOOL_SIZE  +   \
...
} tommRoC_hw_devices_mems_lis2dw12_config_t;

#define __EMPTY_tommRoC_hw_devices_mems_lis2dw12_config_t__                         \
{                                                                                   \
...
typedef struct {
    uint8_t data[TOMMROC_HW_DEVICES_MEMS_LIS2DW12_DEVICE_DATA_SIZE];
} tommRoC_hw_devices_mems_lis2dw12_device_data_t;
 ...
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesMEMSLIS2DW12InitI2C(
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesMEMSLIS2DW12InitSPI(
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesMEMSLIS2DW12AttachDeviceData(
        const   tommRoC_hw_devices_mems_lis2dw12_device_data_t* const   deviceDataPtr,
                tommRoC_hw_bus_device_t*                        const   busDevicePtr);
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesMEMSLIS2DW12Start(
        const   tommRoC_hw_devices_mems_lis2dw12_config_t*      const   configPtr,
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesMEMSLIS2DW12Get(
        const   tommRoC_hw_bus_device_t*                        const   busDevicePtr,
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesMEMSLIS2DW12Get16Bit(
        const   tommRoC_hw_bus_device_t*                        const   busDevicePtr,
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesMEMSLIS2DW12GetTemp(
        const   tommRoC_hw_bus_device_t*                        const   busDevicePtr,
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesMEMSLIS2DW12GetTemp8Bit(
        const   tommRoC_hw_bus_device_t*                        const   busDevicePtr,
