...
#ifndef TOMMROC_HW_DEVICES_MEMS_BMA400_H_
#define TOMMROC_HW_DEVICES_MEMS_BMA400_H_
...
#define TOMMROC_HW_DEVICES_MEMS_BMA400_I2C_7_BIT_ADDRESS_SDO_PIN_GND    (0b0010100)
#define TOMMROC_HW_DEVICES_MEMS_BMA400_I2C_7_BIT_ADDRESS_SDO_PIN_VDD    (0b0010101)


// Device data.
#define TOMMROC_HW_DEVICES_MEMS_BMA400_DEVICE_DATA_SIZE (1)
...
} tommRoC_hw_devices_mems_bma400_config_t;

#define __EMPTY_tommRoC_hw_devices_mems_bma400_config_t__                           \
{                                                                                   \
...
typedef struct {
    uint8_t data[TOMMROC_HW_DEVICES_MEMS_BMA400_DEVICE_DATA_SIZE];
} tommRoC_hw_devices_mems_bma400_device_data_t;
 ...
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesMEMSBMA400InitI2C(
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesMEMSBMA400InitSPI(
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesMEMSBMA400AttachDeviceData(
        const   tommRoC_hw_devices_mems_bma400_device_data_t*   const   deviceDataPtr,
                tommRoC_hw_bus_device_t*                        const   busDevicePtr);
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesMEMSBMA400Start(
        const   tommRoC_hw_devices_mems_bma400_config_t*        const   configPtr,
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesMEMSBMA400Get(
        const   tommRoC_hw_bus_device_t*                        const   busDevicePtr,
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesMEMSBMA400Get16Bit(
        const   tommRoC_hw_bus_device_t*                        const   busDevicePtr,
