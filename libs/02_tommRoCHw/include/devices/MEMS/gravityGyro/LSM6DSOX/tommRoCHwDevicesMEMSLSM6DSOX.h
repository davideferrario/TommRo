...
#ifndef TOMMROC_HW_DEVICES_MEMS_LSM6DSOX_H_
#define TOMMROC_HW_DEVICES_MEMS_LSM6DSOX_H_
...
#define TOMMROC_HW_DEVICES_MEMS_LSM6DSOX_I2C_7_BIT_ADDRESS_SA0_PIN_GND  (0b1101010)
#define TOMMROC_HW_DEVICES_MEMS_LSM6DSOX_I2C_7_BIT_ADDRESS_SA0_PIN_VDD  (0b1101011)


// Device data.
#if defined (TOMMRO_C_ENV_MEMORY_ARCHITECTURE_IS_8_BIT_SIZE)
#define TOMMROC_HW_DEVICES_MEMS_LSM6DSOX_PAD_SIZE ()
#elif defined (TOMMRO_C_ENV_MEMORY_ARCHITECTURE_IS_16_BIT_SIZE)
#define TOMMROC_HW_DEVICES_MEMS_LSM6DSOX_PAD_SIZE ()
#elif defined (TOMMRO_C_ENV_MEMORY_ARCHITECTURE_IS_32_BIT_SIZE)
#define TOMMROC_HW_DEVICES_MEMS_LSM6DSOX_PAD_SIZE (1)
#elif defined (TOMMRO_C_ENV_MEMORY_ARCHITECTURE_IS_64_BIT_SIZE)
#define TOMMROC_HW_DEVICES_MEMS_LSM6DSOX_PAD_SIZE (5)
#endif

#define TOMMROC_HW_DEVICES_MEMS_LSM6DSOX_DEVICE_DATA_SIZE   (   TOMMROC_UTIL_FUNCT_PTR_SIZE                 +   \
                                                                TOMMROC_UTIL_FUNCT_PTR_SIZE                 +   \
                                                                TOMMROC_UTIL_FUNCT_PTR_SIZE                 +   \
                                                                TOMMROC_UTIL_PTR_SIZE                       +   \
                                                                TOMMROC_UTIL_U8_SIZE                        +   \
                                                                TOMMROC_UTIL_U16_SIZE                       +   \
                                                                TOMMROC_HW_DEVICES_MEMS_LSM6DSOX_PAD_SIZE       )
...
typedef enum {
    ...
    TOMMROC_HW_DEVICES_MEMS_LSM6DSOX_SELF_TEST_DISABLE = 0,
    TOMMROC_HW_DEVICES_MEMS_LSM6DSOX_SELF_TEST_POSITIVE,
    TOMMROC_HW_DEVICES_MEMS_LSM6DSOX_SELF_TEST_NEGATIVE

} tommRoC_hw_devices_mems_lsm6dsox_self_test_enum_t;
...
} tommRoC_hw_devices_mems_lsm6dsox_gravity_config_t;

#define __EMPTY_tommRoC_hw_devices_mems_lsm6dsox_gravity_config_t__             \
{                                                                               \
...
} tommRoC_hw_devices_mems_lsm6dsox_gyro_config_t;

#define __EMPTY_tommRoC_hw_devices_mems_lsm6dsox_gyro_config_t__                \
{                                                                               \
    /* .operatingMode */    TOMMRO_C_HW_DEVICES_DEF_OPERATING_MODE_LOW_POWER,   \
    /* .fullScale */        TOMMRO_C_HW_DEF_MEMS_GYRO_FULL_SCALE_125DPS,        \
}
...
typedef struct {
    ...
    tommRoC_hw_devices_mems_lsm6dsox_gravity_config_t   gravityConfig;
    tommRoC_hw_devices_mems_lsm6dsox_gyro_config_t      gyroConfig;

} tommRoC_hw_devices_mems_lsm6dsox_config_t;

#define __EMPTY_tommRoC_hw_devices_mems_lsm6dsox_config_t__                                 \
{                                                                                           \
    /* .gravityConfig */    __EMPTY_tommRoC_hw_devices_mems_lsm6dsox_gravity_config_t__,    \
    /* .gyroConfig */       __EMPTY_tommRoC_hw_devices_mems_lsm6dsox_gyro_config_t__,       \
}
...
typedef struct {
    uint8_t data[TOMMROC_HW_DEVICES_MEMS_LSM6DSOX_DEVICE_DATA_SIZE];
} tommRoC_hw_devices_mems_lsm6dsox_device_data_t;
 ...
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesMEMSLSM6DSOXInitI2C(
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesMEMSLSM6DSOXInitSPI(
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesMEMSLSM6DSOXAttachDeviceData(
        const   tommRoC_hw_devices_mems_lsm6dsox_device_data_t* const   deviceDataPtr,
                tommRoC_hw_bus_device_t*                        const   busDevicePtr);
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesMEMSLSM6DSOXStart(
        const   tommRoC_hw_devices_mems_lsm6dsox_config_t*      const   configPtr,
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesMEMSLSM6DSOXGet(
        const   tommRoC_hw_bus_device_t*                        const   busDevicePtr,
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesMEMSLSM6DSOXGravityGet(
        const   tommRoC_hw_bus_device_t*                        const   busDevicePtr,
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesMEMSLSM6DSOXGravityGet16Bit(
        const   tommRoC_hw_bus_device_t*                        const   busDevicePtr,
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesMEMSLSM6DSOXGyroGet(
        const   tommRoC_hw_bus_device_t*                        const   busDevicePtr,
                tommRoC_hw_mems_def_result_t*                   const   resultPtr);

/**
 * Set MEMS acceleration self-test enabled status.
 *
 * param[in]        busDevicePtr            bus device pointer.
 * param[out]       selfTestStatus          self test status.
 *
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesMEMSLSM6DSOXGravitySelfTestSet(
        const   tommRoC_hw_bus_device_t*                            const   busDevicePtr,
        const   tommRoC_hw_devices_mems_lsm6dsox_self_test_enum_t           selfTestStatus);

/**
 * Set MEMS gyroscope self-test enabled status.
 *
 * param[in]        busDevicePtr            bus device pointer.
 * param[out]       selfTestStatus          self test status.
 *
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesMEMSLSM6DSOXGyroSelfTestSet(
        const   tommRoC_hw_bus_device_t*                            const   busDevicePtr,
        const   tommRoC_hw_devices_mems_lsm6dsox_self_test_enum_t           selfTestStatus);

/**
 * Enable FIFO and move FIFO interrupt to INT1.
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesMEMSLSM6DSOXGravityFIFOINT1(
        const   tommRoC_hw_bus_device_t*                        const   busDevicePtr);
