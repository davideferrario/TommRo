...
#ifndef TOMMROC_HW_DEVICES_MEMS_LSM6DSM_H_
#define TOMMROC_HW_DEVICES_MEMS_LSM6DSM_H_
...
#define TOMMROC_HW_DEVICES_MEMS_LSM6DSM_I2C_7_BIT_ADDRESS_AD0_PIN_GND  (0b1101010)
#define TOMMROC_HW_DEVICES_MEMS_LSM6DSM_I2C_7_BIT_ADDRESS_AD0_PIN_VDD  (0b1101011)


// Device data.
#define TOMMROC_HW_DEVICES_MEMS_LSM6DSM_DEVICE_DATA_SIZE    (   TOMMROC_UTIL_U8_SIZE    +   \
...
} tommRoC_hw_devices_mems_lsm6dsm_gravity_config_t;

#define __EMPTY_tommRoC_hw_devices_mems_lsm6dsm_gravity_config_t__              \
{                                                                               \
...
} tommRoC_hw_devices_mems_lsm6dsm_gyro_config_t;

#define __EMPTY_tommRoC_hw_devices_mems_lsm6dsm_gyro_config_t__                 \
{                                                                               \
    /* .operatingMode */    TOMMRO_C_HW_DEVICES_DEF_OPERATING_MODE_LOW_POWER,   \
...
typedef struct {
    ...
    tommRoC_hw_devices_mems_lsm6dsm_gravity_config_t    gravityConfig;
    tommRoC_hw_devices_mems_lsm6dsm_gyro_config_t       gyroConfig;

} tommRoC_hw_devices_mems_lsm6dsm_config_t;

#define __EMPTY_tommRoC_hw_devices_mems_lsm6dsm_config_t__                              \
{                                                                                       \
    /* .gravityConfig */    __EMPTY_tommRoC_hw_devices_mems_lsm6dsm_gravity_config_t__, \
    /* .gyroConfig */       __EMPTY_tommRoC_hw_devices_mems_lsm6dsm_gyro_config_t__,    \
}
...
typedef struct {
    uint8_t data[TOMMROC_HW_DEVICES_MEMS_LSM6DSM_DEVICE_DATA_SIZE];
} tommRoC_hw_devices_mems_lsm6dsm_device_data_t;
 ...
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesMEMSLSM6DSMInitI2C(
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesMEMSLSM6DSMInitSPI(
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesMEMSLSM6DSMAttachDeviceData(
        const   tommRoC_hw_devices_mems_lsm6dsm_device_data_t*  const   deviceDataPtr,
                tommRoC_hw_bus_device_t*                        const   busDevicePtr);
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesMEMSLSM6DSMStart(
        const   tommRoC_hw_devices_mems_lsm6dsm_config_t*       const   configPtr,
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesMEMSLSM6DSMGet(
        const   tommRoC_hw_bus_device_t*                        const   busDevicePtr,
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesMEMSLSM6DSMGravityGet(
        const   tommRoC_hw_bus_device_t*                        const   busDevicePtr,
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesMEMSLSM6DSMGravityGet16Bit(
        const   tommRoC_hw_bus_device_t*                        const   busDevicePtr,
 ...
 * return tommRoC_hw_err_enum_t
 */
tommRoC_hw_err_enum_t tommRoCHwDevicesMEMSLSM6DSMGyroGet(
        const   tommRoC_hw_bus_device_t*                        const   busDevicePtr,
                tommRoC_hw_mems_def_result_t*                   const   resultPtr);
