...
#ifndef TOMMROC_HW_COMM_NFC_NDEF_TYPE_TNF6_H_
#define TOMMROC_HW_COMM_NFC_NDEF_TYPE_TNF6_H_
...
tommRoC_hw_err_enum_t tommRoCHwCommNFCNDEFTypeTNF6UnchangedRecordEncode(
...
tommRoC_hw_err_enum_t tommRoCHwCommNFCNDEFTypeTNF6UnchangedRecordDecode(
