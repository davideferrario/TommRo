 ...
 * local defines
 ******************************************************************************/
#define __DHCP_TASK_RATE_MSEC__             (10)
#define __DHCP_ON_ENTER_PAUSE_DELAY_MSEC__  (100)
#define __DHCP_ON_ENTER_RESUME_DELAY_MSEC__ (100)
...
static void _wait_for_net_itf_is_up(void) {
    ...
    for (;;) {
        ...
        TOMMROC_ASSERT_TOMMROC_LIB_FUNCT_SUCCESS(tommRoCOsDelayMsec(__DHCP_ON_ENTER_PAUSE_DELAY_MSEC__ / 4));
    }
}

static void _wait_for_net_link_is_up(void) {
...
static tommRoC_hw_err_enum_t _dhcp_pause_funct(void) {
    _is_paused = true;
    TOMMROC_ASSERT_TOMMROC_LIB_FUNCT_SUCCESS(tommRoCOsDelayMsec(__DHCP_ON_ENTER_PAUSE_DELAY_MSEC__));
    return TOMMRO_C_HW_ERR_SUCCESS;
}

static tommRoC_hw_err_enum_t _dhcp_resume_funct(void) {
    _is_paused = false;
    TOMMROC_ASSERT_TOMMROC_LIB_FUNCT_SUCCESS(tommRoCOsDelayMsec(__DHCP_ON_ENTER_RESUME_DELAY_MSEC__));
    return TOMMRO_C_HW_ERR_SUCCESS;
}
