...
#ifndef TOMMROC_HW_TEMPLATE_BUS_UART_SILABS_LOCATION_H_
#define TOMMROC_HW_TEMPLATE_BUS_UART_SILABS_LOCATION_H_
...
} tommRoC_hw_template_bus_uart_silabs_location_t;

#if defined (_USART_ROUTE_LOCATION_MASK)
#define __EMPTY_tommRoC_hw_template_bus_uart_silabs_location_t__    \
{                                                                   \
