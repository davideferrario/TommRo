...
#ifndef TOMMROC_HW_TEMPLATE_BUS_ENVIRONMENT_I2C_SLAVE_H_
#define TOMMROC_HW_TEMPLATE_BUS_ENVIRONMENT_I2C_SLAVE_H_
...
#if defined (__TOMMROC_HW_TEMPLATE_BUS_I2C_SLAVE_DEF_AT_LEAST_ONE_IS_USED__)
