...
#ifndef TOMMROC_HW_TEMPLATE_BUS_SPI_MASTER_SW_H_
#define TOMMROC_HW_TEMPLATE_BUS_SPI_MASTER_SW_H_
 ...
 ******************************************************************************/
    ...
    defined (__TOMMROC_HW_USE_SPI_MASTER_1_SW_TEMPLATE__) ||   \
    defined (__TOMMROC_HW_USE_SPI_MASTER_2_SW_TEMPLATE__)      \

#define __TOMMROC_HW_AT_LEAST_ONE_SPI_MASTER_SW_TEMPLATE_IS_USED__
...
// SPI master software structure for init.
typedef struct {

    tommRoC_hw_gpio_set_cb_t    clkHigh;
    tommRoC_hw_gpio_set_cb_t    clkLow;
    tommRoC_hw_gpio_set_cb_t    mosiHigh;
    tommRoC_hw_gpio_set_cb_t    mosiLow;
    tommRoC_hw_gpio_get_cb_t    misoStatus;

    tommRoC_hw_template_bus_spi_master_mode_t   mode;
    uint16_t                                    baudRateKbits;

} tommRoC_hw_template_bus_spi_master_sw_init_t;

#define __EMPTY_tommRoC_hw_template_bus_spi_master_sw_init_t__              \
{                                                                           \
    /* .clkHigh */          NULL,                                           \
    /* .clkLow */           NULL,                                           \
    /* .mosiHigh */         NULL,                                           \
    /* .mosiLow */          NULL,                                           \
    /* .misoStatus */       NULL,                                           \
    /* .mode */             TOMMRO_C_HW_TEMPLATE_BUS_SPI_MASTER_MODE_0,     \
    /* .baudRateKbits */    0,                                              \
}
