...
#ifndef TOMMROC_HW_TEMPLATE_BUS_COMMON_UART_FIFO_H_
#define TOMMROC_HW_TEMPLATE_BUS_COMMON_UART_FIFO_H_
...
typedef struct {
    ...
    tommRoC_fifo_ISR_t  fifo;
    bool                fifoIsInit;

} tommRoC_hw_template_bus_common_uart_fifo_t;

#define __EMPTY_tommRoC_hw_template_bus_common_uart_fifo_t__                        \
{                                                                                   \
    /* .fifo */         { { [ 0 ... (sizeof(tommRoC_fifo_ISR_t) - 1) ] = 0x00 } },  \
    /* .fifoIsInit */   false,                                                      \
}
