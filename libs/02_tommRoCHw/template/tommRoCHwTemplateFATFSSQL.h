...
#ifndef TOMMROC_HW_TEMPLATE_FAT_FS_SQL_H_
#define TOMMROC_HW_TEMPLATE_FAT_FS_SQL_H_
...
/**
 * Init SQL framework for a FATFS file system.
 *
...
/**
 * Close SQL framework for a FATFS file system.
 *
 * return tommRoC_hw_err_enum_t
 */
