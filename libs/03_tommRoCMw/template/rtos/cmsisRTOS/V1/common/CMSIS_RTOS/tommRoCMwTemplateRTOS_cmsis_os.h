...
#ifndef TOMMROC_MW_TEMPLATE_RTOS_CMSIS_V1_OS_H_
#define TOMMROC_MW_TEMPLATE_RTOS_CMSIS_V1_OS_H_
...
#include "rtos/cmsisRTOS/V1/common/CMSIS_RTOS/env/esp32/cmsis_os.h"

#elif defined (__TOMMROC_MW_ARM_CMSIS_RTOS_INTERNAL_TEMPLATE_IS_USED__)
#include "rtos/cmsisRTOS/V1/common/CMSIS_RTOS/env/freeRTOS/cmsis_os.h"
#endif
