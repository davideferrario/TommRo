...
2. tommRoCHw - hardware - library. A set of common hardware functionalities (buses, bus devices, network, BLE,...) that can be used in firmware projects.
3. tommRoCMw - middleware - library. A set of common RTOS functionalities (thread, mutex,...) that can be used in firmware projects.
